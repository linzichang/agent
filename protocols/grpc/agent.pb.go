...
type Storage struct {
	...
	// inside the container. This is used to determine which Mount from the
	// OCI specification should be updated, otherwise the source will be
	// wrong.
	// The rootfs case is specific since no Mount will be listed from the
	// OCI specification.
	MountPoint string `protobuf:"bytes,6,opt,name=mount_point,json=mountPoint,proto3" json:"mount_point,omitempty"`
	// Rootfs is a simple flag indicating if the current storage represents
	// a root filesystem or a simple volume.
	Rootfs bool `protobuf:"varint,7,opt,name=rootfs,proto3" json:"rootfs,omitempty"`
}
...
var fileDescriptorAgent = []byte{
	...
	0x17, 0xfe, 0x6d, 0x9c, 0xd8, 0xf1, 0xb1, 0x9d, 0xa4, 0x93, 0x36, 0xd9, 0x9f, 0x5b, 0x95, 0xb0,
	...
	,
}
